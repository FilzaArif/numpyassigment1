...
def function3():
    ...
    x = ax = a[(a%5==0) & (a%7==0)].tolist() #wrtie your code here
    print(x)
    return x
    """
    Expected Output:
...
def function4():
    ...
    arr = np.arange(9).reshape(3,3)  #wrtie your code here
    print (arr[:, [1,0,2]])
...
def function5():
    ...
    z =np.zeros(shape=(4,5), dtype=np.int), #wrtie your code here
...
def function6():
    ...
    arr =np.zeros(shape=(10), dtype=np.int)
    arr[4] = 10
...
def fucntion20():
    ...
    return  x = x*2+3-2 #Write your Code here
    print([x,])
